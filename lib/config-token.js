...
export async function getConfigToken() {
  ...
  console.log(`[config-token] Rotation succeeded (team: ${data.team_id}, user: ${data.user_id}, expires: ${new Date(data.exp * 1000).toISOString()}, new refresh prefix: ${data.refresh_token.slice(0, 8)}...)`);
